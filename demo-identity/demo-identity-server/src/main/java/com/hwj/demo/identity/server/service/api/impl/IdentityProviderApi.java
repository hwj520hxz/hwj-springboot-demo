package com.hwj.demo.identity.server.service.api.impl;
...
import com.hwj.demo.identity.dto.IdentityAttributeDTO;
 ...
 */
@Service
public class IdentityProviderApi implements IIdentityProviderApi {

    private static final Logger LOGGER = LoggerFactory.getLogger(IdentityProviderApi.class);
    ...
    @Override
    public Long save(IdentityDTO identityDTO) {
