...
export default {
  ...
  methods: {
    ...
    resize () {
      this.grid.height = this.$el.clientHeight - this.$el.querySelector('.search-bar').clientHeight - this.$el.querySelector('.tool-bar').clientHeight - this.$el.querySelector('.pagination').clientHeight - 2
    }
  }
}
</script>
